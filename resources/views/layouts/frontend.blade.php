    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          ...
          <li>Bạn trả tiền, chúng tôi trao tri thức</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                ...
                >
                  ...
                  <span class="arrow_carrot-down"></span>
                  <ul>
                    <li><a href="#">Xin chào {{ auth()->user()->username }}</a></li>
                  </ul>
                </div>
                <div class="header__top__right__auth">
                  <a href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit()"><i class="fa fa-user"></i> Logout</a>
          ...
          <div class="col-lg-6">
            <nav class="header__menu">
              <ul>
                ...
                <li><a href="http://aboutteam-env.eba-aujsfm3x.us-east-1.elasticbeanstalk.com/" target="_blank">Liên hệ</a></li>
              </ul>
            </nav>
          </div>
          <div class="col-lg-3">
