...
@section('content')
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.products.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="category_id">Chọn phân loại cho SP</label>
                    ...
                    <div class="form-group">
                        <label for="tags">Chọn thẻ gán cho SP</label>
                    ...
                    <div class="form-group">
                        <label for="weight">Số lượng dự trù</label>
                    ...
                    <div class="form-group">
                        <label for="details">Mô tả đầy đủ</label>
                    ...
                    <div class="form-group {{ $errors->has('gallery') ? 'has-error' : '' }}">
                        <label for="gallery">Ảnh minh họa</label>
            ...
            <div>
                <p><strong>Lưu ý: </strong> <i>Mô tả ngắn</i> nên để tên nhà xuất bản/nhà cung ứng</p>
                <p>&nbsp;<i>Mô tả đầy đủ</i> nêu ra đầy đủ chi tiết về sản phẩm, tránh ghi các thông tin nhạy cảm, cần được bảo mật, vì chúng sẽ được hiển thị lên giao diện bán hàng.</p>
            </div>
@endsection
